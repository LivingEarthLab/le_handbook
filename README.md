# Living Earth Handbook

## Contributor guidelines
Contributions are welcome and greatly appreciated! To contribute, please follow the following guidelines:

**Reporting issues**
* Check that the issue has not already been reported on the [issue tracker](https://github.com/LivingEarthLab/le_handbook/issues).
* Submit an issue on the [issue tracker](https://github.com/LivingEarthLab/le_handbook/issues).
